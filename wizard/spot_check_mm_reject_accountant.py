...
class SpotCheckRejectAccountantMM(models.TransientModel):
    _name = "spot_check.reject_accountant_mm"
    _description = "Reject"
    _rec_name = 'state'
    ...
    def reject_mm(self):
        ...
        for req in spot:
            ...
            template_id = self.env.ref('spot_check.email_template_create_mm_request_accountant_rejected').id
