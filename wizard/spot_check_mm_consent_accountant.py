...
class SpotCheckConsentAccountantMM(models.TransientModel):
    _name = "spot_check.consent_accountant_mm"
    ...
    def consent_mm(self):
        ...
        for req in spot:
            ...
            template_id = self.env.ref('spot_check.email_template_create_mm_request_to_manager').id
