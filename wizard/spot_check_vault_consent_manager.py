...
class SpotCheckConsentManager(models.TransientModel):
    _name = "spot_check.consent_manager"
    ...
    @api.multi
    def consent_vault_manager(self):
        ...
        for req in spot:
            ...
            template_id = self.env.ref('spot_check.email_template_create_vault_request_final').id
