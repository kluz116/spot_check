...
class SpotCheckRejectAccountantUsd(models.TransientModel):
    _name = "spot_check.reject_accountant_usd"
    _description = "Reject"
    _rec_name = 'state'
    ...
    def reject_vault_usd(self):
        ...
        for req in spot:
            ...
            template_id = self.env.ref('spot_check.email_template_create_vault_request_accountant_rejected_usd').id
