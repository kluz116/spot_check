...
class SpotCheckRejectManager(models.TransientModel):
    _name = "spot_check.reject_manager"
    _description = "Reject"
    _rec_name = 'state'
    ...
    def reject_vault_manager(self):
        ...
        for req in spot:
            ...
            template_id = self.env.ref('spot_check.email_template_create_vault_request_manager_rejected').id
