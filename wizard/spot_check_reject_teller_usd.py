...
class SpotCheckRejectTellerUsd(models.TransientModel):
    _name = "spot_check.cash_reject_teller_usd"
    _description = "Reject"
    _rec_name = 'state'
    ...
    def reject_teller_usd(self):
        ...
        for req in spot:
            ...
            template_id = self.env.ref('spot_check.email_template_create_teller_request_reject_usd').id
