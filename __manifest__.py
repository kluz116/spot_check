# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'wizard/spot_check_mm_consent_accountant.xml',
        'wizard/spot_check_mm_consent_manager.xml',
        'wizard/spot_check_mm_reject_accountant.xml',
        'wizard/spot_check_mm_reject_manager.xml',
        'views/branch.xml',
